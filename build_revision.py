...
add_table(doc, ["编号", "变体", "所检验的机制"], [
    ...
    ("A4", "w/o Macro Prompt", "保留 Coarse branch，但关闭 Macro-Trend Prompt 的生成与注入"),
    ("A5", "w/o Reverse Cross", "只保留 Coarse → Fine，关闭 Fine → Coarse"),
    ("A6", "w/o Cross Fusion", "保留两条分支，但关闭双向交叉融合"),
