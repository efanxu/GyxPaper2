...
5. 正式 A6 Single-direction Cross Fusion 必须继续使用 `fusion_mode=cross` 和学习型 adaptive gate，仅通过 `disable_reverse_cross=True` 关闭 Fine→Coarse 交互；Coarse/Macro→Fine attention、Fine 分支残差和 LayerNorm 均保持开启。
