...
def create_model(*, config: Mapping[str, Any], protocol: Mapping[str, Any], **_: Any) -> Any:
    from ..models.moving_average import create_model as _create_model
...
def resolve_config(protocol: Mapping[str, Any], *, run_mode: str = "formal", ma_window: int | None = None) -> dict[str, Any]:
    from ..configs.moving_average import resolve_moving_average_config

    return resolve_moving_average_config(protocol, run_mode=run_mode, ma_window=ma_window)
