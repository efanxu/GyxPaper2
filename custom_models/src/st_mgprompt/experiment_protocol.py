...
_COMPONENT = (
    ...
    ExperimentVariant(
        "A4", "w/o Macro Prompt", "component_ablation", True,
        None, "CANONICAL_FULL", {"use_macro_prompt": False},
        ("use_macro_prompt",),
    ),
    ExperimentVariant(
        "A5", "w/o Reverse Cross", "component_ablation", True,
        None, "CANONICAL_FULL", {"disable_reverse_cross": True},
        ("disable_reverse_cross",),
    ),
    ExperimentVariant(
        "A6", "w/o Cross Fusion", "component_ablation", True,
        None, "CANONICAL_FULL", {"use_cross_fusion": False},
        ("use_cross_fusion",),
    ),
    ExperimentVariant(
        "A7", "w/o ST Prompt", "component_ablation", True,
        None, "CANONICAL_FULL",
        {"use_st_prompt": False, "decoder_input_strategy": "direct_multi_output_horizon_head"},
        ("use_st_prompt", "decoder_input_strategy"),
    ),
    ExperimentVariant(
