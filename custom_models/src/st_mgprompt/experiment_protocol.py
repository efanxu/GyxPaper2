...
ARCHITECTURE_AND_LOSS_FIELDS = (
    ...
    "st_prompt_use_horizon_identity", "st_prompt_use_shared_horizon_embedding",
    "st_prompt_use_type_embedding", "st_prompt_type_semantics",
...
SEMANTIC_CONFIG_DEFAULTS = {
    ...
    "st_prompt_use_horizon_identity": True,
    "st_prompt_use_shared_horizon_embedding": False,
    "st_prompt_use_type_embedding": True,
    "st_prompt_type_semantics": "fixed_decoder_input_type",
