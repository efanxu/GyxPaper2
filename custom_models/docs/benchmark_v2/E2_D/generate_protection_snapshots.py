...
FORMAL_OUTPUT_ROOT = (
    PROJECT_ROOT / "custom_models/results/benchmark_v2/e2_d_seed2026"
)
...
GROUPS: dict[str, list[str]] = {
    ...
    "benchmark_frozen": [
        ...
        "custom_models/src/benchmark_v2/contracts.py",
        "custom_models/src/benchmark_v2/trainer.py",
        "custom_models/src/benchmark_v2/evaluator.py",
    ],
    "e1_a": [
...
def main() -> None:
    ...
    for name, paths in GROUPS.items():
        ...
        output.write_text(
            json.dumps(make_snapshot(name, args.phase, paths),
