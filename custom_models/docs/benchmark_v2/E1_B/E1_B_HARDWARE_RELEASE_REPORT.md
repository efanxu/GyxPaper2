...
The old GTX 1060 OOM evidence is permanently retained: `known_smoke_*`, `historical_local_full_shape_status`, complete OOM summary, peak-memory record, hardware identity, and `custom_models/docs/benchmark_v2/E1_B/full_shape_model_smoke_results.json`. That artifact and TiDE/SegRNN source/config/adapter hashes are protected and unchanged.
