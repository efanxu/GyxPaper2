...
E0-B froze the benchmark_v2 public runtime and stopped before E1-A. The only protocol source is `custom_models/src/benchmark_v2/protocol/benchmark_protocol_v1.json`; its record is `<removed-content-record>`.
...
Protection: core and TSLib before/after snapshots have zero mismatches. Canonical content record before and after is `<removed-content-record>`. ST-MGPrompt core, TSLib sources, Canonical, P0-P5/A0-A8 and old result directories were not modified; no dependency was installed/upgraded/deleted and no file was deleted.
