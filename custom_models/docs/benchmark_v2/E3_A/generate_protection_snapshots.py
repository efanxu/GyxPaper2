...
FORMAL_OUTPUT_ROOT = (
    PROJECT_ROOT / "custom_models/results/benchmark_v2/e3_a_seed2026"
)
...
GROUPS: dict[str, list[str]] = {
    ...
    "benchmark_frozen": [
        ...
        "custom_models/src/benchmark_v2/adapters/native_spatiotemporal.py",
