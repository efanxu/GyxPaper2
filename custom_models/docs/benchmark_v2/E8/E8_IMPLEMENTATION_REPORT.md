...
Static source audit confirms the intended A4/A5/A6/A7 differences: A4 changes only Macro Prompt temporal pooling, A5 shortens Reverse Cross context while retaining both directions, A6 excludes the latest 24 Fine positions from Macro-to-Fine queries, and A7 shares the two cross-attention projection modules. This static result does not override the formal protocol evidence gap.
