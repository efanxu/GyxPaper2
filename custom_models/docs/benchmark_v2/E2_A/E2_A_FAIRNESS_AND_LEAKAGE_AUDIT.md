...
- TimeXer: frozen feature-order record is checked; index 15 must be `Patv_clean_for_input`. Indices 0–14 are historical exogenous features. Any future exogenous tensor is rejected, including an all-zero supplied tensor; non-zero future observed/exogenous input is fail-closed.
